...
async def gen_thumb(videoid):
    ...
    try:
        ...
        return f"https://telegra.ph/file/48d0b7478c6a82ac3068e.jpg"
...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𖤐↜𝑺𝑶𝑼𝑹𝑪𝑬 𝑾𝑶𝑹𝑳𝑫↝𖤐", url=f"https://t.me/H_H_H_P")],
...
🎧 **بواسطه:** {ruser}
        ...
        try:
            ...
            if 'CreateGroupCall' in str(e):
                ...
                return await dream.edit_text(f"{e}\n◍ في حاله ظهور لك مثل هذه المشكله تواصل مع المطور -> @M_9_T")
    ...
    if admin(msg):
        ...
        if command == "/pause":
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("𖤐↜𝑺𝑶𝑼𝑹𝑪𝑬 𝑾𝑶𝑹𝑳𝑫↝𖤐", url="https://t.me/H_H_H_P")],
